...
| image:check.png["cochez la case"] | Aucune 
|===
Pour plus d'informations sur le déploiement, consultez link:../concepts/infra.html["Découvrez l'infrastructure Keystone"] et link:..//concepts/components.html["Composants requis pour les services Keystone"].
