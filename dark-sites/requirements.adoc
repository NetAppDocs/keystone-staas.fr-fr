...
---
= Configuration requise pour Keystone Collector en mode privé
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Chaque mois, exportez un fichier depuis Keystone Collector et envoyez-le par courriel à l’équipe d’assistance NetApp. Pour plus d’informations sur la façon de contacter l’équipe d’assistance, consultez link:../concepts/support-services.html["Services de support pour Keystone"].
