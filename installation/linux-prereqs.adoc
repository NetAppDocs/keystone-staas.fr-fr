...
Les configurations suivantes sont requises pour le serveur Linux :
...
Les configurations suivantes sont requises pour la machine virtuelle (SVM) du serveur Keystone Collector :
