...
[role="lead"]
Si vous êtes abonné aux services STaaS NetApp Keystone, vous pouvez contrôler votre utilisation dans le widget *abonnements Keystone* du tableau de bord conseiller numérique.

Pour plus d'informations sur le widget Digital Advisor, reportez-vous à la section https://docs.netapp.com/us-en/active-iq/task_view_keystone_capacity_utilization.html["Consultez l'utilisation de la capacité sur l'abonnement NetApp Keystone"^].
