...
[%collapsible]
====
Si vous vous êtes abonné au service complémentaire de protection avancée des données, vous pouvez afficher l'éclatement des données de consommation pour les sites partenaires MetroCluster dans l'onglet *série de temps d'abonnement*.
