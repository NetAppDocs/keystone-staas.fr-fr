...
** *Engagé* : La capacité engagée sous contrat.
...
Vous pouvez consulter les prévisions d'utilisation de la capacité pour les 120 prochains jours à compter de la date actuelle grâce à l'option *Prévisions* disponible dans la vue *Historique de consommation* de l'onglet *Tendance de consommation* de la Console. L'option est activée par défaut.
...
Si vous sélectionnez une période qui ne se termine pas à la date du jour, les prévisions sont automatiquement désactivées. Pour les réactiver, une boîte de dialogue de confirmation vous informe que les données de prévisions ne sont disponibles que lorsque la période sélectionnée se termine à la date du jour. La confirmation rétablit l'affichage par défaut, correspondant aux 30 derniers jours de données historiques plus les 120 prochains jours de prévisions.
