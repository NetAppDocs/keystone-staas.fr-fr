...
+
Vous voyez les informations détaillées sur les volumes dans les clusters, y compris le nom du volume, le numéro de série du nœud, le nom du cluster, le nom de l'hôte et les niveaux de service de performance. Vous pouvez également surveiller la capacité provisionnée, l'utilisation logique et physique, les données froides et les données chaudes.
